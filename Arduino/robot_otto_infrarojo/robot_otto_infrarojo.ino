/* Proyecto modificado por Felipe Flores
...
// CONTROL REMOTO
long cero = 16738455; //16738455
long uno = 16724175;
long dos = 16718055;
long tres = 16743045;
long cuatro = 16716015;
long cinco = 16726215;
long seis = 16734885;
long siete = 16728765;
long ocho = 16730805;
long nueve = 16732845;
long detener = 16748655;
...
void loop() {
  if (irrecv.decode(&results)) {
    ...
    if (results.value == cuatro) {
      Serial.println("Es cuatro");
      moonWalkLeft(4, t * 2);
    }
    if (results.value == cinco) {
      Serial.println("Es cinco");
      drunk(t * 4);
    }
    if (results.value == seis) {
      Serial.println("Es seis");
      crusaito(1, t * 8);
    }
    if (results.value == siete) {
      Serial.println("Es siete");
      primera_parte();
    }
    if (results.value == ocho) {
      Serial.println("Es ocho");
      segunda_parte();
    }
    if (results.value == nueve) {
      Serial.println("Es nueve");
      backyard(2, t * 2);
    }
