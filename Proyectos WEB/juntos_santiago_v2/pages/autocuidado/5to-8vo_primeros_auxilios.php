...
<head>
    ...
    <title>5°-8° Básico | Primeros Auxilios</title>
    ...
    <div class="wrapper white-bg">
       ...
       <!--  <div class="text-center">
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/60b2dce589103c0d7c05b5d5" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseUno" class="collapse" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/60b50641a39e7f0d874b0a42" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe>
                        </div> 
                    </div>
                    ...
                    <div id="collapseTres" class="collapse" data-parent="#accordion">
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>1. Los primeros auxilios son técnicas básicas y simples aplicadas en los primeros momentos de un accidente o enfermedad, lo que pueden...</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>2. Usted está en el casino de su colegio almorzando, de pronto un niño de primero básico (pequeña altura) se comienza a ahogar con un trozo de carne ¿Cómo se posicionaría usted para hacerle la maniobra al niño?</h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>3. ¿Qué debemos hacer para poder inmovilizar la zona de la fractura?</h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>4. ¿En cuál de las siguientes situaciones la herida debe manejarse en un servicio de Salud? </h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                ...
                                <button type="submit" name ="enviar" value= "quinto_octavo_basico_primeros_auxilios_autocuidado" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'quinto_octavo_basico_reanimacion_cardiopulmonar_autocuidado') { //cambiar 
                error_reporting(0);
