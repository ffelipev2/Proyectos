...
<head>
    ...
    <title>Primeros Auxilios | Signos Vitales y Reanimación</title>
...
<!-- end Google analytics-->
    ...
    <div class="wrapper white-bg">
        ...
        <div class="text-center">
            ...
            <div class="centrado breadcrumbs-title"><h2>Primeros Auxilios </br></br>Signos Vitales y Reanimación</h2></div>
            </div>
            <!-- <div class="container">
                <div class="row">
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f47c29ee3669e23d5b67478" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
