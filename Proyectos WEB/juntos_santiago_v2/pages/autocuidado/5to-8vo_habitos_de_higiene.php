...
<head>
    ...
    <title>5°-8° Básico | Hábitos de Higiene</title>
...
<!-- end Google analytics-->
    ...
    <div class="wrapper white-bg">
        ...
        <div class="row text-center">
            <div class="col-12">
                <button class="btn btn-modulos btn-lg mx-auto btn-">5°-8° Básico</button>
            </div>
        </div>
        <!-- End button titulo-->
        <!--header section end-->
       ...
       <!--  <div class="text-center">
        ...
        <div class="container border p-0">
            <div class="card-header collapsed border border-light" data-toggle="collapse" data-parent="#accordion" href="#collapseCuatro"  style ="background-color: #6bc513;">
                <a class="card-title"><img src="../../images/icono_lecciones/icono1_leccion1.png" class="img-fluid" width="70px" alt="70px"> Módulo Educativo: Hábitos de Higiene</a> <!--cambiar en caso de ser necesario-->
            </div>
        </div>
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/60b2ee4e89103c0d7c05b793" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseUno" class="collapse" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/60b4fe79f7e7df0d7731cad2" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe>
                        </div> 
                    </div>
                    ...
                    <div id="collapseTres" class="collapse" data-parent="#accordion">
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>2. ¿Cuál es la forma correcta de secar el cuerpo luego de ducharse?</h5>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta2" id="exampleRadios1" value="A" required>
                                        <label class="form-check-label" for="exampleRadios1">
                                            a) Secar todo el cuerpo con una toalla limpia y húmeda
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta2" id="exampleRadios2" value="B">
                                        <label class="form-check-label" for="exampleRadios2">
                                            b) Secar con una toalla limpia y seca y no dejar una zona de la toalla para secar exclusivamente los genitales 
                                        </label>
                                    </div>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="pregunta2" id="exampleRadios3" value="C">
                                        <label class="form-check-label" for="exampleRadios3">
                                            c) Secar con una toalla limpia y seca y dejar una zona de la toalla para secar exclusivamente los genitales  
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta2" id="exampleRadios3" value="D">
                                        <label class="form-check-label" for="exampleRadios3">
                                            d) No es necesario secarse
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <h5>3. ¿Cuánto es el tiempo de duración apropiado del cepillado dental?</h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                ...
                                <button type="submit" name ="enviar" value= "quinto_octavo_basico_habitos_de_higiene_autocuidado" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'quinto_octavo_basico_habitos_de_higiene_autocuidado') { //cambiar 
                error_reporting(0);
