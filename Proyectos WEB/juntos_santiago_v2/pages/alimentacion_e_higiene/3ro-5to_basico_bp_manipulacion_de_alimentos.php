...
<head>
    ...
    <title>3°-5° Básico | BP Manipulación de Alimentos</title>
    ...
    <div class="wrapper white-bg">
       ...
       <!-- Star button titulo-->
        <div class="row text-center">
            <div class="col-12">
                <button class="btn btn-modulos btn-lg mx-auto btn-">1°-2° Básico</button>
            </div>
        </div>
        <!-- End button titulo-->
        <!--header section end-->
       ...
       <!--  <div class="text-center">
        ...
        <div class="container border p-0">
            <div class="card-header collapsed border border-light" data-toggle="collapse" data-parent="#accordion" href="#collapseCuatro"  style ="background-color: #6bc513;">
                <a class="card-title"><img src="../../images/icono_lecciones/icono1_leccion1.png" class="img-fluid" width="70px" alt="70px"> Módulo Educativo: BP Manipulación de Alimentos</a> <!--cambiar en caso de ser necesario-->
            </div>
        </div>
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5fbc4c7342acc60d1e4c945e" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseUno" class="collapse" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f7134579768fe0d387ae414" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe>
                        </div> 
                    </div>
                    ...
                    <div id="collapseTres" class="collapse" data-parent="#accordion">
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>2.	Los beneficios de lavar los vegetales son</h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>4.	Después de ver el material educativo sobre manipulación de alimentos: </h5>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios1" value="A" required>
                                        <label class="form-check-label" for="exampleRadios1">
                                            a) En tu casa están desinfectando las frutas y verduras según protocolo mostrado
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios2" value="B">
                                        <label class="form-check-label" for="exampleRadios2">
                                            b) En tu casa sólo lavan las frutas y verduras con agua
                                        </label>
                                    </div>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios3" value="C">
                                        <label class="form-check-label" for="exampleRadios3">
                                            c) En tu casa no lavan ni desinfectan las frutas y verduras 
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios3" value="D">
                                        <label class="form-check-label" for="exampleRadios3">
                                            d) No entendimos bien como hacer el lavado y desinfección de las frutas y verduras
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <button type="submit" name ="enviar" value= "tercero_quinto_basico_bp_manipulacion_de_alimentos" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
       ...
       /* require_once "../../resources/funciones.php";
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'tercero_quinto_basico_bp_manipulacion_de_alimentos') { //cambiar 
                error_reporting(0);
