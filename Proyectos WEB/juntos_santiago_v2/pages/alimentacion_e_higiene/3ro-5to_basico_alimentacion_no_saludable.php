...
<head>
    ...
    <title>3°-5° Básico | Alimentación No Saludable</title>
     ...
     <!-- Star button titulo-->
       ...
       <!--  <div class="text-center">
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5fb4425733ad030d7330927b" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseUno" class="collapse" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f8c76e7033b070d06269468" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe>
                        </div> 
                    </div>
                    ...
                    <div id="collapseTres" class="collapse" data-parent="#accordion">
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>2.	¿Qué consecuencias trae el alto consumo de grasas y calorías?</h5>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta2" id="exampleRadios1" value="A" required>
                                        <label class="form-check-label" for="exampleRadios1">
                                            a) Tener un crecimiento adecuado
                                        </label>
                                    </div>
                                    <div class="form-check">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="exampleRadios3">
                                            d) No genera ninguna consecuencia 
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <button type="submit" name ="enviar" value= "tercero_quinto_basico_alimentacion_no_saludable" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'tercero_quinto_basico_alimentacion_no_saludable') { //cambiar 
                error_reporting(0);
