...
<head>
    ...
    <title>6°-8° Básico | Lavado de Manos</title>
       ...
       <!--  <div class="text-center">
        ...
        <div class="container border p-0">
            <div class="card-header collapsed border border-light" data-toggle="collapse" data-parent="#accordion" href="#collapseCuatro"  style ="background-color: #6bc513;">
                <a class="card-title"><img src="../../images/icono_lecciones/icono1_leccion1.png" class="img-fluid" width="70px" alt="70px"> Módulo Educativo: Lavado de Manos</a> <!--cambiar en caso de ser necesario-->
            </div>
        </div>
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f2d9b470c238a0d9c225652" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseUno" class="collapse" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f1510af08cedb0d748795a2" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe>
                        </div> 
                    </div>
                    ...
                    <div id="collapseTres" class="collapse" data-parent="#accordion">
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>1. ¿Qué ocurre si me paso las manos sin lavar por los ojos, nariz y/o boca?</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>4. Después de ver el material educativo del lavado de manos </h5>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios1" value="A" required>
                                        <label class="form-check-label" for="exampleRadios1">
                                            a)	Me lavo siempre las manos con agua y jabón igual siguiendo las instrucciones.
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios2" value="B">
                                        <label class="form-check-label" for="exampleRadios2">
                                            b)	Me lavo las manos con agua y jabón pero sin seguir las instrucciones.
                                        </label>
                                    </div>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios3" value="C">
                                        <label class="form-check-label" for="exampleRadios3">
                                            c)	Me lavo a veces las manos sólo con agua 
                                        </label>
                                    </div>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                ...
                                <button type="submit" name ="enviar" value= "sexto_octavo_lavado_de_manos" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'sexto_octavo_lavado_de_manos') { //cambiar 
                error_reporting(0);
