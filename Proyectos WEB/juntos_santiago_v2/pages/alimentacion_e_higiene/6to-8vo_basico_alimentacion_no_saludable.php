...
<head>
    ...
    <title>6°-8° Básico | Alimentación No Saludable</title>
...
<!-- end Google analytics-->
    ...
    <div class="wrapper white-bg">
        ...
        <div class="row text-center">
            <div class="col-12">
                <button class="btn btn-modulos btn-lg mx-auto btn-">6°-8° Básico</button>
            </div>
        </div>
        <!-- End button titulo-->
        <!--header section end-->
       ...
       <!--  <div class="text-center">
        ...
        <div class="container border p-0">
            <div class="card-header collapsed border border-light" data-toggle="collapse" data-parent="#accordion" href="#collapseCuatro"  style ="background-color: #6bc513;">
                <a class="card-title"><img src="../../images/icono_lecciones/icono1_leccion1.png" class="img-fluid" width="70px" alt="70px"> Módulo Educativo: Alimentación No Saludable</a> <!--cambiar en caso de ser necesario-->
            </div>
        </div>
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f2cb0a6fa6ef00d76820d4a" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseUno" class="collapse" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f17a0ff4887c20d901460c6" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe>
                        </div> 
                    </div>
                    ...
                    <div id="collapseTres" class="collapse" data-parent="#accordion">
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>2. Los alimentos NO saludables poseen características similares entre sí, cual es la más correcta y/o completa de las siguientes afirmaciones:</h5>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta2" id="exampleRadios1" value="A" required>
                                        <label class="form-check-label" for="exampleRadios1">
                                            a)	Poseer sellos de advertencias 
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta2" id="exampleRadios2" value="B">
                                        <label class="form-check-label" for="exampleRadios2">
                                            b)	Fritos, envasados con muchos ingredientes y poseer sellos de advertencia
                                        </label>
                                    </div>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="pregunta2" id="exampleRadios3" value="C">
                                        <label class="form-check-label" for="exampleRadios3">
                                            c)	Fritos y envasados con pocos ingredientes 
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta2" id="exampleRadios3" value="D">
                                        <label class="form-check-label" for="exampleRadios3">
                                            d)	Fritos y envasados con muchos ingredientes
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <h5>3. ¿Cuáles son las consecuencias de consumir alimentos no saludables en exceso? Recuerda que sólo hay una respuesta correcta.</h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                ...
                                <button type="submit" name ="enviar" value= "sexto_octavo_alimentacion_no_saludable" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
       ...
       /* require_once "../../resources/funciones.php";
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'sexto_octavo_alimentacion_no_saludable') { //cambiar 
                error_reporting(0);
