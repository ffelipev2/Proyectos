...
<head>
    ...
    <title>6°-8° Básico | BP Manipulación de Alimentos</title>
    ...
    <div class="wrapper white-bg">
       ...
       <!--  <div class="text-center">
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f0f8165b860cd0d82725a88" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseUno" class="collapse.show" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe src="https://wordwall.net/es/embed/d0d22aeeac0e418b8e6c58c5fc48c0a7?themeId=31&templateId=69" width="500" height="380" frameborder="0" allowfullscreen></iframe>
                        </div> 
                    </div>
                    ...
                    <div id="collapseTres" class="collapse" data-parent="#accordion">
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>1.	¿Cuál es la diferencia entre limpieza y sanitización?</h5>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta1" id="exampleRadios1" value="A" required>
                                        <label class="form-check-label" for="exampleRadios1">
                                            a)	Limpieza es la desinfección del alimento, mientras que sanitización es la eliminación de residuo visibles.
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta1" id="exampleRadios2" value="B">
                                        <label class="form-check-label" for="exampleRadios2">
                                            b)	Limpieza es el lavado con un producto químico, mientras que sanitización es la eliminación de residuos visibles.
                                        </label>
                                    </div>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="pregunta1" id="exampleRadios3" value="C">
                                        <label class="form-check-label" for="exampleRadios3">
                                            c)	Limpieza es la eliminación de residuos visibles, mientras que sanitización es la limpieza con un producto químico.
                                        </label>
                                    </div>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>2.	¿Cuál es la temperatura adecuada de cocción de los alimentos?</h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                ...
                                <button type="submit" name ="enviar" value= "sexto_octavo_bp_manipulacion_de_alimentos" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'sexto_octavo_bp_manipulacion_de_alimentos') { //cambiar 
                error_reporting(0);
