...
<head>
    ...
    <title>6°-8° Básico | Prevencion TCA</title>
       ...
       <!--  <div class="text-center">
        ...
        <div class="container border p-0">
            <div class="card-header collapsed border border-light" data-toggle="collapse" data-parent="#accordion" href="#collapseCuatro"  style ="background-color: #6bc513;">
                <a class="card-title"><img src="../../images/icono_lecciones/icono1_leccion1.png" class="img-fluid" width="70px" alt="70px"> Módulo Educativo:Prevencion TCA</a> <!--cambiar en caso de ser necesario-->
            </div>
        </div>
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5fbc15a3cbed770da5ed9ea5" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseUno" class="collapse.show" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe src="https://view.genial.ly/5f7bc8cc279f7c75ca63e64d" width="500" height="380" frameborder="0" allowfullscreen></iframe>
                        </div> 
                    </div>
                    ...
                    <div id="collapseTres" class="collapse" data-parent="#accordion">
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>4.	¿Qué son los Trastornos de la Conducta Alimentaria (TCA)? </h5>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios1" value="A" required>
                                        <label class="form-check-label" for="exampleRadios1">
                                            a) Se relacionan con problemas con la comida pero no son peligrosos 
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios2" value="B">
                                        <label class="form-check-label" for="exampleRadios2">
                                            b) Son enfermedades que sufren personas con sobrepeso y obesidad
                                        </label>
                                    </div>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios3" value="C">
                                        <label class="form-check-label" for="exampleRadios3">
                                            c) Son trastornos a la salud mental relacionados con la alimentación, que pueden ser gatillados por muchas razones, tales como el bulliyng, la depresión, el abuso sexual, la baja autoestima, entre otros. 
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios3" value="D">
                                        <label class="form-check-label" for="exampleRadios3">
                                            d) Son enfermedades que se gatillan sólo por seguir modas relacionadas con la alimentación.
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                ...
                                <button type="submit" name ="enviar" value= "sexto_octavo_basico_tca" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'sexto_octavo_basico_tca') { //cambiar 
                error_reporting(0);
