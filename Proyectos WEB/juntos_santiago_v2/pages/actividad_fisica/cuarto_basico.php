...
<!-- end Google analytics--> 
    ...
    <div class="wrapper white-bg">
        ...
        <div class="row text-center">
            <div class="col-12">
                <button class="btn btn-modulos btn-lg mx-auto btn-">4° Básico</button>
            </div>
        </div>
        <!-- End button titulo-->
        <!--header section end-->
       ...
       <!--  <div class="text-center">
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/60a3c36771554e0d06d1cba6" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseUno" class="collapse" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/60ad288b30bffb0d9477bc58" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe>
                        </div> 
                    </div>
                    ...
                    <div id="collapseTres" class="collapse" data-parent="#accordion">
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>1.	¿En qué deporte se utilizan más las habilidades de locomoción?</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>2.	¿Que habilidad es más necesaria para jugar al fútbol? </h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>3. ¿En qué profesión se necesita desarrollar más la expresión corporal?</h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>4.	Conociendo la importancia de desarrollar tus habilidades físicas, ¿cuántas veces has practicado los ejercicios y juegos que hemos preparado para ti? </h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                ...
                                <button type="submit" name ="enviar" value= "cuarto_basico_actividad_fisica" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'cuarto_basico_actividad_fisica') { //cambiar 
                error_reporting(0);
