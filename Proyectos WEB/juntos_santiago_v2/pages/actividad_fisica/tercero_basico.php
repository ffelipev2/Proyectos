    ...
    <body>
        ...
        <div class="wrapper white-bg">
            ...
            <div class="row text-center">
                <div class="col-12">
                    <button class="btn btn-modulos btn-lg mx-auto btn-">3° Básico</button>
                </div>
            </div>
            <!-- End button titulo-->
            <!--header section end-->
            ...
            <div class="container border p-0">
                <div style="width: 100%;">
                    <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                        <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/60a3c31171554e0d06d1cb9e" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                        </iframe> 
                    </div> 
                </div>
            </div>
                ...
                <div id="accordion" class="accordion">
                    <div class="card mb-0">
                        ...
                        <div id="collapseUno" class="collapse" data-parent="#accordion">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/60ad27e5ecb7a70d1fa0a5ba" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe>
                            </div> 
                        </div>
                            ...
                            <div class="card-body"> 
                                <form role="form" action="" method="post">
                                    ...
                                    if ($_SESSION['userName'] != '') {
                                        echo ' <button type="submit" name ="enviar" value= "tercero_basico_actividad_fisica" class="btn btn-primary btn-outline-primary">Enviar</button>';
                                    }
                                    ?>
            ...
            /*
              ...
              $conn->Crearconexion();
              if (isset($_POST['enviar'])) {
              if ($_POST['enviar'] == 'tercero_basico_actividad_fisica') { //cambiar
              error_reporting(0);
