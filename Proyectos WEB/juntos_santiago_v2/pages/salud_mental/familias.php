...
<head>
    ...
    <title>Salud Mental | Familias</title>
...
<!-- end Google analytics-->
    ...
    <div class="wrapper white-bg">
        ...
        <div class="row text-center">
            <div class="col-12">
                <button class="btn btn-modulos btn-lg mx-auto btn-">Salud Mental Familias</button>
            </div>
        </div>
        <!-- End button titulo-->
        <!--header section end-->
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/60b65c6d9f478b0d11b0e591" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
