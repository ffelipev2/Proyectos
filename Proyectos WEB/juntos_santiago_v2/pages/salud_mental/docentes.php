...
<head>
    ...
    <title>Salud Mental | Docentes</title>
...
<!-- end Google analytics-->
    ...
    <div class="wrapper white-bg">
       ...
       <div class="row text-center">
            <div class="col-12">
                <button class="btn btn-modulos btn-lg mx-auto btn-">Salud Mental Docentes</button>
            </div>
        </div>
        <!-- End button titulo-->
        <!--header section end-->
       ...
       <!--  <div class="text-center">
        ...
        <div class="container border p-0">
            <div class="card-header collapsed border border-light" data-toggle="collapse" data-parent="#accordion" href="#collapseCuatro"  style ="background-color: #6bc513;">
                <a class="card-title"><img src="../../images/icono_lecciones/icono1_leccion1.png" class="img-fluid" width="70px" alt="70px"> Motivación y aprendizaje </a> <!--cambiar en caso de ser necesario-->
            </div>
        </div>
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/60b658f09e490a0d78adaf66" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <!-- <div  class="card-header collapsed border border-light " data-toggle="collapse" data-parent="#accordion" href="#collapseUno"  style =" background-color: #6bc513; ">
                        <a class="card-title"><img src="../../images/icono_lecciones/icono2_simulacion.png" class="img-fluid" width="70px" alt="70px"> Manejo de emociones </a>
                    </div>
                    <div id="collapseUno" class="collapse" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f4680874506081220b283ad" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe>
                        </div> 
                    </div> -->
                    ...
                    <div id="collapseTres" class="collapse" data-parent="#accordion">
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>1.	¿CÓMO MANTENER EL BIENESTAR EMOCIONAL EN SITUACIONES DE SOBRECARGA LABORAL?</h5>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta1" id="exampleRadios1" value="A" required>
                                        <label class="form-check-label" for="exampleRadios1">
                                            a)	Es importante dedicar mayor número de horas al trabajo, de esta forma logramos nuestros objetivos laborales
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta1" id="exampleRadios2" value="B">
                                        <label class="form-check-label" for="exampleRadios2">
                                            b)	Evitar espacios de ocio que me distraigan
                                        </label>
                                    </div>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="pregunta1" id="exampleRadios3" value="C">
                                        <label class="form-check-label" for="exampleRadios3">
                                            c)	Establecer un cambio rotundo de rutinas que me permita recordar mi nuevo estado
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta1" id="exampleRadios3" value="D">
                                        <label class="form-check-label" for="exampleRadios3">
                                            d)	Al final de la jornada guarde todo lo que tenga que ver con el trabajo
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <h5>2.	¿CÓMO FORTALECER LA AUTOESTIMA EN DOCENTES?</h5>
                                    <div class="form-check">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="exampleRadios2">
                                            b)	Mejorar la percepción de seguridad, es decir sentirme seguro de lo que pienso y siento
                                        </label>
                                    </div>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="pregunta2" id="exampleRadios3" value="C">
                                        <label class="form-check-label" for="exampleRadios3">
                                            c)	No siempre se puede sentir cómodo en la situación en que se encuentra y eso está bien
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta2" id="exampleRadios3" value="D">
                                        <label class="form-check-label" for="exampleRadios3">
                                            d)	Es importante que mis jefes busquen la manera de motivarme en mi trabajo
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <h5>3.	¿CÓMO DEBERÍAMOS CONTROLAR LA RESPIRACIÓN PARA DISMINUIR LA ANSIEDAD?</h5>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta3" id="exampleRadios1" value="A" required>
                                        <label class="form-check-label" for="exampleRadios1">
                                            a)	El fenómeno de la hiperventilación en una acción necesaria para calmar mi cuerpo
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta3" id="exampleRadios2" value="B">
                                        <label class="form-check-label" for="exampleRadios2">
                                            b)	La respiración controlada implica estar gran parte del día controlado la respiración 
                                        </label>
                                    </div>
                                    <div class="form-check ">
                                        <input class="form-check-input" type="radio" name="pregunta3" id="exampleRadios3" value="C">
                                        <label class="form-check-label" for="exampleRadios3">
                                            c)	Respirar algunos minutos por la nariz y expirar otros minutos por la boca de manera controlada es la base del ejercicio
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta3" id="exampleRadios3" value="D">
                                        <label class="form-check-label" for="exampleRadios3">
                                            d)	Cuando estoy nervioso respiro más dióxido de carbono y libero más oxígeno.
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <h5>4.	¿CONSIDERA USTED QUÉ LOS VIDEOS ENTREGAN HERRAMIENTAS QUE LE PERMITAN ENFRENTAR DE MEJOR FORMA EL AÑO ACADÉMICO?</h5>
                                    <div class="form-check">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="pregunta4" id="exampleRadios3" value="E">
                                        <label class="form-check-label" for="exampleRadios3">
                                            e) En desacuerdo 
                                        </label>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <button type="submit" name ="enviar" value= "salud_mental_docentes" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'salud_mental_docentes') { //cambiar 
                error_reporting(0);
