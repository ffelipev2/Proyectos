...
<head>
    ...
    <title>Salud Mental | Familias - Estudiantes</title>
...
<!-- end Google analytics-->
    ...
    <div class="wrapper white-bg">
        ...
        <div class="text-center">
            ...
            <img src="../../images/header_pages/salud_mental_final.jpg"/>
            <div class="centrado breadcrumbs-title"><h2>Salud Mental  </br></br> Familias - Estudiantes</h2></div>
            </div>
            <!-- <div class="container">
                <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12">
                        <img src="../../images/header_pages/actividad_fisica_3.jpg" alt="Responsive image" class="img-fluid">
                        <div class="breadcrumbs-title">
                        <h2>Videos 1°-3° Básico</h2>
                        </div>
                    </div>
                </div>
            </div> -->
        ...
        <div class="container border p-0">
            <div style="width: 100%;">
                <div style="position: relative; padding-bottom: 56.25%; padding-top: 0; height: 0;">
                    <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f4679158487d50d49bcfb7b" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all">
                    </iframe> 
                </div> 
            </div>
        </div>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseUno" class="collapse" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://view.genial.ly/5f457e69f44733176c200472" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe>
                        </div> 
                    </div>
                    ...
                    <div id="collapseTres" class="collapse" data-parent="#accordion">
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>1.	¿CUÁLES SON ALGUNOS DE LOS FACTORES QUE INFLUYEN EN LA MOTIVACIÓN PARA EL APRENDIZAJE?</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>2.	¿CÓMO GENERAR BUENOS HÁBITOS DE ESTUDIO PARA MEJORAR LOS RESULTADOS ACADEMICOS?</h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>3.	¿CÓMO PODEMOS FOMENTAR LA PARENTALIDAD POSITIVA?</h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5>4.	¿QUÉ TÉCNICAS PUEDEN SER ÚTILES PARA ENFRENTAR LA ANSIEDAD?</h5>
                                    <div class="form-check">
                            ...
                            <div class="card">
                                ...
                                <button type="submit" name ="enviar" value= "salud_mental_familias_estudiates" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'salud_mental_familias_estudiates') { //cambiar 
                error_reporting(0);
