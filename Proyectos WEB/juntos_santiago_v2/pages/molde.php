...
<head>
    ...
    <title>7° y 8° Básico | Alimentacion Saludable</title>
...
<body>     
    <div class="wrapper white-bg">
        ...
        <div class="text-center">
            ...
            <img src="../../images/header_pages/higiene_y_alimentacion_final.jpg"/>
            <div class="centrado breadcrumbs-title"><h2>7° y 8° Básico  </br></br> Alimentacion Saludable</h2></div>
            </div>
            <!-- <div class="container">
                <div class="row">
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseUno" class="collapse" data-parent="#accordion">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe frameborder="0" width="1200px" height="675px" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://wordwall.net/es/embed/f90e462986124b1cacf8a9fea6bf52ec?themeId=31&templateId=69" type="text/html" allowscriptaccess="always" allowfullscreen="true" scrolling="yes" allownetworking="all"></iframe>
                        </div> 
                    </div>
                        ...
                        <div class="card-body"> 
                            ...
                            <div class="card">
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea4">5.- Califica los materiales didácticos</label>
                                ...
                                <button type="submit" name ="enviar" value= "actividad_fisica_primero_basico" class="btn btn-primary btn-outline-primary">Enviar</button><!--cambiar valor de value-->
                            </form>
                        </div>
                    </div>                 
        ...
        if (isset($_POST['enviar'])) {
            if ($_POST['enviar'] == 'actividad_fisica_primero_basico') { //cambiar 
                error_reporting(0);
