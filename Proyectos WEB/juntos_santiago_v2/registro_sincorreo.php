...
if (isset($_POST['submit'])) {
    ...
    $codSchool = $_POST['codSchool'];
    $codCourse = $_POST['codCourse'];
    ...
    if (!isset($error)) {
        ...
        try {
            ...
            $stmt = $db->prepare('INSERT INTO usuarios (userName, name1 , name2, lastName1,lastName2, password, email, phone, address, codSchool, codCourse, codRol, active) VALUES (:userName, :name1, :name2, :lastName1, :lastName2,:password, :email, :phone,:address, :codSchool,:codCourse,:codRol, :active)');
            $stmt->execute(array(
                ':userName' => $userName,
                ':name1' => $name1,
                ':name2' => $name2,
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="text-center">
                    <img src="images/logo.png" class="img-fluid" width="300px" height="100px">
                </div>
                </br>
                <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                    <form role="form" method="post" action="" autocomplete="off">
                        ...
                        <div class="form-group">
                            <input type="text" name="name1" id="name2" class="form-control input-lg" required  placeholder="Primer Nombre" value="<?php
                            if (isset($error)) {
                                echo htmlspecialchars($_POST['name1'], ENT_QUOTES);
                            }
                            ?>" tabindex="2">
                        </div>
                        <div class="form-group">
                            <input type="text" name="name2" id="name2" class="form-control input-lg" required  placeholder="Segundo Nombre" value="<?php
                            if (isset($error)) {
                                echo htmlspecialchars($_POST['name2'], ENT_QUOTES);
                            }
                            ?>" tabindex="2">
                        </div>
                        <div class="form-group">
                            <input type="text" name="lastName1" id="lastName" class="form-control input-lg" required  placeholder="Primer apellido" value="<?php
                            if (isset($error)) {
                                echo htmlspecialchars($_POST['lastName1'], ENT_QUOTES);
                            }
                            ?>" tabindex="4">
                        </div>
                        <div class="form-group">
                            <input type="text" name="lastName2" id="lastName" class="form-control input-lg" required  placeholder="Segundo apellido" value="<?php
                            if (isset($error)) {
                                echo htmlspecialchars($_POST['lastName2'], ENT_QUOTES);
                            }
                            ?>" tabindex="4">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" name="phone" id="phone" class="form-control input-lg" required placeholder="Telefono" value="<?php
                            if (isset($error)) {
                        ...
                        <div class="form-group">
                            <input type="text" name="address" id="phone" class="form-control input-lg" required placeholder="Dirección" value="<?php
                            if (isset($error)) {
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <select class="form-control input-lg" name ="" id="comunas" tabindex="6" required onchange="selectorColegio(this.value)">
                                        <option value="">Seleciona Comuna</option>
                                        <option value="PV"> Providencia </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group" >
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <select class="form-control input-lg" name = "codSchool" id = "resultado_1" tabindex="6" required>
                                        <option  value="">Seleciona Colegio</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <select class="form-control input-lg"  data-live-search="true" name = "codCourse" id="course" tabindex="6" required >
                                <option  value="">Selecionar Curso</option>
                                <option value="PBA"> Primero Básico A</option>
                                <option value="PBB"> Primero Básico B </option>
                                <option value="PBC"> Primero Básico C </option>
                                <option value="PBD"> Primero Básico D </option>
                                <option value="PBF"> Primero Básico F </option>
                            </select>
                        </div>
                        <div class="form-group">
                            <select class="form-control input-lg" name ="codRol" id="comunas" tabindex="6" required >
