        ...
        <div class = "container-fluid">
            <div class = "row">
                <div class = "col-sm-8 col-md-offset-2">
                    <div>
                        <img style = "display:flex; margin:0 auto;"src = "imagenes/modp_1.png" class = "img-rounded">
                    </div>
                    <form action="" method="POST" role="form" class="form-horizontal">  
                        ...
                        <div class = "col-sm-12 form-group">
                            <button type = "submit"  name='modificarproducto' class = "btn btn-primary center-block">Enviar</button>
                        </div>
                    </form>
