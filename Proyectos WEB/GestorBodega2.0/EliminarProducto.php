        ...
        <div class = "container-fluid">
            <div class = "row">
                <div class = "col-sm-8 col-md-offset-2">
                    <div>
                        <img style = "display:flex; margin:0 auto;"src = "imagenes/delete.png" class = "img-rounded">
                    </div>
                    <form action="" method="POST" role="form" class="form-horizontal">  

                        <div class = "form-group">
                            <label for = "pwd">Codigo del producto a eliminar:</label>
                            <input type = "text" name="codigoproducto" class = "form-control" placeholder = "" required>
                        </div>
                        <div class = "col-sm-12 form-group">
                            <button type = "submit"  name='eliminarproducto' class = "btn btn-primary center-block">Enviar</button>
                        </div> 
                    </form>
