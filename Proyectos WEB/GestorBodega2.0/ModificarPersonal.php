...
<html lang="es">
    <head>
        ...
        <!-- DATA TABLES*****************************************************-->
        <script src="js/jquery-v1.12.3.min.js" type="text/javascript"></script>
        ...
        <div class = "container-fluid">
            <div class = "row">
                <div class = "col-sm-8 col-md-offset-2">
                    <div>
                        <img style = "display:flex; margin:0 auto;"src = "imagenes/mod.png" class = "img-rounded">
                    </div>
                    <form action="" method="POST" role="form" class="form-horizontal">  
                        ...
                        <div class = "col-sm-12 form-group">
                            <button type = "submit"  name='modificar' class = "btn btn-primary center-block">Enviar</button>
                        </div>
                    </form>
