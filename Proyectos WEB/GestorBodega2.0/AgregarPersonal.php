        ...
        <div class = "navbar navbar-default navbar-fixed-top" role = "navigation">
            <div class = "container-fluid">
                <div class = "navbar-header">
                    ...
                    <a class = "navbar-brand" href = "index.html">GESTIÓN DE BODEGA</a>
                </div>
        ...
        <div class = "container-fluid">
            <div class = "row">
                <div class = "col-sm-8 col-md-offset-2">
                    <div>
                        <img style = "display:flex; margin:0 auto;"src = "imagenes/usuarios.png" class = "img-rounded">
                    </div>
                    <form action="" method="POST" role="form" class="form-horizontal">  
                        <div class = "form-group">
                            <label name="Seleccionar">Nuevo rut: </label>
                            <input type="text" class = "form-control" id="rut" name="seleccionar" required oninput="checkRut(this)" placeholder="Ingrese RUT"required/>
                        </div>
                        ...
                        <div class = "form-group">
                            ...
                            <select class = "form-control" id = "sel1"  name="cargo" required>
                        ...
                        <div class = "form-group">
                            ...
                            <input  type="password" name="pass1" class = "form-control" placeholder = "" required  id="pwd">
                        </div>

                        <div class = "form-group">
                            <label for = "pwd">Confirme su contraseña:</label>
                            <input  type="password" name="pass2" class = "form-control" placeholder = "" required  id="pwd">
                        </div>

                        <div class = "col-sm-12 form-group">
                            <button type = "submit"  name='agregarpersonal' class = "btn btn-primary center-block">Enviar</button>
                        </div>
                    </form>
                    ...
                    if (isset($_POST['agregarpersonal'])) {
                        $db->agregarPersonal();
                        $db->desconectar();
                    }
                    $db->desconectar();
