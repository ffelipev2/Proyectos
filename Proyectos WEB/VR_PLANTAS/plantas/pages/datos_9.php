...
<html>
    <head>
        ...
        <meta http-equiv="Refresh" content="600" URL="http://192.168.0.120/datos_9.php">
        <meta charset="utf-8">
        <!-- JAVASCRIPT -->
    ...
    <body>
        ...
        <div class="container h1"><div class="row justify-content-center"> <p>Planta 9</p> </div> </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                if (isset($_POST['consultar'])) {
                    ...
                    $conn->mostrar_datos('datos_planta_9', 'plantas', $dato_fecha);
                    echo '</div>';
                    echo '<div class="col-lg-4"  >';
                    $conn->mostrar_dashboard('datos_planta_9', 'plantas', $dato_fecha);
                    echo '</div>';
                } else {
        ...
        <div class="container">
            <div class="row">              
                ...
                $sqlQuery = "SELECT hora FROM datos_planta_9 WHERE fecha = '" . $dato_fecha . "'";
...
<?php
$sqlQuery2 = "SELECT temperatura FROM datos_planta_9 WHERE fecha = '" . $dato_fecha . "'";
