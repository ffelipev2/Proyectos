...
<html>
    ...
    <body>
        ...
        <div class="container h1"><div class="row justify-content-center"> <p>Planta 1</p> </div> </div>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                if (isset($_POST['consultar'])) {
                    ...
                    $conn->mostrar_datos('datos_planta_1', 'plantas', $dato_fecha);
                    echo '</div>';
                    echo '<div class="col-lg-4"  >';
                    $conn->mostrar_dashboard('datos_planta_1', 'plantas', $dato_fecha);
                    echo '</div>';
                } else {
        ...
        <div class="container">
            <div class="row">              
                <?php
                //$conn = mysqli_connect("186.64.115.210", "plantasp_felipe", "arduino123456", "plantasp_1");
                require_once "../accesos/config.php";
                $conn = mysqli_connect(HOST, USER, PASSWORD, DATABASE);
                $sqlQuery = "SELECT hora FROM datos_planta_1 WHERE fecha = '" . $dato_fecha . "'";
...
<?php
$sqlQuery2 = "SELECT temperatura FROM datos_planta_1 WHERE fecha = '" . $dato_fecha . "'";
