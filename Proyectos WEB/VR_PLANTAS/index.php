                ...
                <div>
                    <div class="home-slider--wrapper__inner" style="background-image: url('assets/img/slider.jpg')">
                        <div class="container">
                            ...
                            <h1>Bienvenidos a Titanx</h1>
                            <span class="dot-dash">.</span>
                            <!--<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>-->
                            <p>Aquí encontraras algunos proyectos tecnológicos</p>
                            <div class="slider-buttons">
                                <a href="plantas/index.php" class="button">Proyecto Plantas</a>
                                <a href="vrmakeit/index.html" class="button">Proyecto AR y VR</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <footer>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <p><a href="http://fit.uss.cl/laboratorios/make-it-lab/">Desarrollado por Make iT Lab USS</a></p>
                    </div>
                </div>
            </div>
        </footer>
